...
export const LAUNCHER_HUD_WIDTH = 248;
...
export const HUD_COPY = {
  inspector: {
    ...
    detail: "Same as clicking the circle. Opens the full Inspector.",
  },
  threads: {
    offLabel: "Turn on Threads",
    onLabel: "Threads on",
    offDetail: "Inspect conversations from this app.",
    onDetail: "Threads is on. Opens the Threads view.",
  },
  intelligence: {
    offLabel: "Turn on Intelligence",
    onLabel: "Intelligence connected",
    offDetail: "Connect Intelligence to use Threads and Learning.",
    onDetail: "Intelligence is connected. Opens Home.",
  },
  learning: {
    offLabel: "Turn on Learning",
    onLabel: "Learning on",
    offDetail: "Connect Intelligence to use Learning.",
    onDetail: "Learning is on. Opens the Learning view.",
  },
} as const;
