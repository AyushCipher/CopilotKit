...
import type { ThreadsSetupPromptCopyState } from "../domains/threads/state.js";
import {
  getExampleKind,
...
import {
  ...
  showSetupPromptCopyState,
  THREADS_DOCS_URL,
  THREADS_RUNTIME_SETUP_DOCS_URL,
  THREADS_RUNTIME_SETUP_PROMPT,
...
export class WebInspectorElement extends LitElement {
    ...
    return renderLauncherView({
      ...
      getHudAvailability: () => {
        ...
        return {
          ...
          intelligence: homeModel.hero.connection === "connected",
        };
      },
  ...
  private getHomeModel(): HomeModel {
    ...
    return buildHomeModel({
      ...
      lastRuntimeEvent: lastRuntimeEvent
        ...
        : undefined,
      memoriesOn: this.learning.memoriesAvailable,
  ...
  private handleThreadsSetupPromptCopy = async (
    ...
    const generation = (this.threads.setupPromptCopyGeneration += 1);
    if (this.threads.setupPromptCopyResetTimeoutId !== null) {
      window.clearTimeout(this.threads.setupPromptCopyResetTimeoutId);
      this.threads.setupPromptCopyResetTimeoutId = null;
    }
  ...
  private renderThreadsExampleOverview(locked: boolean) {
    ...
    return renderThreadsOverview({
      ...
      locked,
      lockedCopy,
      licenseState: this.inspectorMetadataProjection.licenseState,
      setupDocsUrl: this.getThreadsRuntimeSetupDocsUrl(),
      ...
      lockedAction: lockedAction
        ...
        : nothing,
      copyIcon: this.renderIcon(
        this.threads.setupPromptCopyState === "copied" ? "Check" : "Copy",
      ),
      onCopySetupPrompt: this.handleThreadsSetupPromptCopy,
    });
  }
  ...
  private renderMemoriesView() {
    return renderLearningView(
      {
        state: this.learning,
        intelligenceEnabled: Boolean(this.core?.intelligence),
        colorScheme: this.colorScheme,
